...
<section class="banner main-container">
    <div class="banner__container">
        ...
        <div class="banner__note">
            @include('client.includes.image', ['image' => $contents['image']])
...
{{--                        </svg>--}}
{{--                    </label>--}}
                    <example-component text="{{ $contents['button-name']['value'] ?? $contents['button-name']['default_value'] }}"></example-component>
                @endif
            </div>
        ...
        <div class="banner__brands">
            @foreach($block->Iterations as $iteration)
                ...
                <div class="banner__brands-item">
                    <img src="{{  url('/') . '/uploads/contents/' . $properties['icon'] ?? ''}}" alt="{{  $properties['icon-name'] ?? '' }}">
                </div>
            @endforeach
        </div>
        @endif
